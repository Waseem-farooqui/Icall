...
public class GroupChatAdapter extends BaseAdapter {
    ...
    public GroupChatAdapter(Activity context, List<ChatMessage> chatMessages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //status=chatMessage.getStatus((int)id);
       //ChatMessage chatMessage = getItem(position);
        ...
        if(myMsg)
            holder.senderInfo.setText("Me");

        else
            holder.senderInfo.setText(chatMessage.getSender());
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            ...
            layoutParams = (LinearLayout.LayoutParams) holder.senderInfo.getLayoutParams();
            layoutParams.gravity = Gravity.LEFT;
            holder.senderInfo.setLayoutParams(layoutParams);


            GroupChatAdapter.this.holder.img.setImageResource(0);
            GroupChatAdapter.this.holder.img1.setImageResource(0);
            ...
            if(status.equals("d")) {
                GroupChatAdapter.this.holder.img.setImageResource(R.drawable.tick);
                GroupChatAdapter.this.holder.img1.setImageResource(0);
            }
            else if(status.equals("r")) {
                GroupChatAdapter.this.holder.img.setImageResource(R.drawable.tick);
                GroupChatAdapter.this.holder.img1.setImageResource(R.drawable.tick);
            }
            else {
                GroupChatAdapter.this.holder.img.setImageResource(0);
                GroupChatAdapter.this.holder.img1.setImageResource(0);
